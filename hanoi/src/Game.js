...
// Pilar: quito botón de resolver y de restore
        ...
        var text = game.add.bitmapText(x, y + 7, 'nokia', ' ', 16);
        ...
        var text = game.add.bitmapText(x, y + 7, 'nokia', 'Reiniciar', 16);
  ...
  this._buttonRestore = this.add.button(x + 440, y, 'button', this.restoreGame, this, 0, 1, 2);
        ...
        this._stAttemps  = this.add.text(22, 22, 'MOVIMIENTOS: ' + this._attemps, style);
        this._stAttemps.fixedToCamera = true;

        this._stTime  = this.add.text(220, 22, 'TIEMPO: ' + this._attemps, style);
        this._stTime.fixedToCamera = true;

        this._stopWatch = new Stopwatch(this._stTime);

        var pieceNumber = this.add.text(550, 22, 'DISCOS: ' + this._numberPiece, style);
